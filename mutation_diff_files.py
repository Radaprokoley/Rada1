...
df = pd.read_excel('/Users/vidya.sasikumar/Desktop/mutation files/hc_mutations_prod_mapped_sorted.xls', usecols="A")
df2 = pd.read_excel('/Users/vidya.sasikumar/Desktop/mutation files/hc_mutation_validation_sorted.xls', usecols="A")
df = pd.DataFrame(df, columns=['Sample ID'])
df2 = pd.DataFrame(df2, columns=['Sample ID'])
df.to_excel("mutation_prod_sample_list.xlsx")
df2.to_excel("mutation_validation_sample_list.xlsx")
wrkbk = openpyxl.load_workbook("mutation_prod_sample_list.xlsx")
sh = wrkbk.active
sample_id_list_prod = []
...
wrkbk = openpyxl.load_workbook("mutation_validation_sample_list.xlsx")
sh = wrkbk.active
